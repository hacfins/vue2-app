        ...
        <template v-else>
            ...
            <view class="uni-panel" v-for="(item, index) in list" :key="item.id">
                ...
                <view class="uni-panel-c" v-if="activeOpen === item.id">
                    <view :class="{'left-win-active': leftWinActive === item2.url && hasLeftWin, 'pc-hide': item2.name === '设置TabBar' && hasLeftWin}" class="uni-navigate-item" v-for="(item2,key) in item.pages" :key="key" :url="item.url">
